...
1. **Sources referenced during project planning**
2. **Tools actually used in the implemented workflow**
3. **Results produced from the final dataset and analysis**

This distinction is important because a professional Data Analytics project should make it clear which sources were consulted, which technologies were actually used, and which conclusions are supported by the final analysis.
...
The project combines Marketing knowledge with technical Data Analytics skills to answer a real business question using evidence rather than opinion.
